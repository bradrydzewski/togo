...
func filesMigrateTmpl() (*asset, error) {
	bytes, err := filesMigrateTmplBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "files/migrate.tmpl", size: 2507, mode: os.FileMode(420), modTime: time.Unix(1490514174, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _filesQueriesTmpl = []byte("\x1f\x8b\x08\x00\x00\x09\x6e\x88\x00\xff\x01\x00\x00\xff\xff\x00\x00\x00\x00\x00\x00\x00\x00")

func filesQueriesTmplBytes() ([]byte, error) {
	return bindataRead(
		_filesQueriesTmpl,
		"files/queries.tmpl",
	)
...
func filesQueriesTmpl() (*asset, error) {
	bytes, err := filesQueriesTmplBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "files/queries.tmpl", size: 0, mode: os.FileMode(420), modTime: time.Unix(1490507837, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	"files/migrate.tmpl": filesMigrateTmpl,
	"files/queries.tmpl": filesQueriesTmpl,
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"files": &bintree{nil, map[string]*bintree{
		"migrate.tmpl": &bintree{filesMigrateTmpl, map[string]*bintree{}},
		"queries.tmpl": &bintree{filesQueriesTmpl, map[string]*bintree{}},
	}},
}}
